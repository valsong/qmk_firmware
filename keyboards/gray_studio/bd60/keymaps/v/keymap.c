...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        LT(4,KC_TAB),  KC_Q,         KC_W,        KC_E,        KC_R,        KC_T,        KC_Y,        KC_U,        KC_I,       KC_O,        KC_P,        KC_LBRC,      KC_RBRC,     KC_BSLS,
        KC_LCTL,       KC_A,         KC_S,        KC_D,        KC_F,        KC_G,        KC_H,        KC_J,        KC_K,       KC_L,        KC_SCLN,     KC_QUOT,                   KC_ENT,
        KC_LSFT,                     KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_N,        KC_M,       KC_COMM,     KC_DOT,      KC_SLSH,                   KC_RSFT,     KC_NO,
        MO(2),         KC_LALT,      KC_LGUI,                               KC_SPC,                                                         KC_RGUI,     MO(2),        MO(3),       MO(2)
    ),
    ...
    [1] = LAYOUT_all(
        ...
        KC_LCTL,       KC_A,         KC_S,        KC_D,        KC_F,        KC_G,        KC_H,        KC_J,        KC_K,       KC_L,        KC_SCLN,     KC_QUOT,                   KC_ENT,
        KC_LSFT,                     KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_N,        KC_M,       KC_COMM,     KC_DOT,      KC_SLSH,                   KC_RSFT,     KC_NO,
        MO(2),         KC_NO,        KC_LALT,                               KC_SPC,                                                         KC_RGUI,     MO(2),        MO(3),       MO(2)
    ),
    ...
    [4] = LAYOUT_all(
        ...
        KC_NO,         KC_NO,        KC_MS_UP,    KC_NO,       KC_NO,       KC_NO,       KC_MS_WH_LEFT,KC_MS_WH_UP,KC_MS_WH_DOWN,KC_MS_WH_RIGHT,   KC_NO, KC_NO,        KC_NO,      KC_NO,
