...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LT(4,KC_TAB),  KC_Q,         KC_W,        KC_E,        KC_R,        KC_T,        KC_Y,        KC_U,        KC_I,       KC_O,        KC_P,        KC_LBRC,      KC_RBRC,     KC_BSLS,            KC_PGUP,
        KC_LCTL,       KC_A,         KC_S,        KC_D,        KC_F,        KC_G,        KC_H,        KC_J,        KC_K,       KC_L,        KC_SCLN,     KC_QUOT,                   KC_ENT,             KC_PGDN,
        KC_LSFT,       KC_LSFT,      KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_N,        KC_M,       KC_COMM,     KC_DOT,      KC_SLSH,      KC_RSFT,     KC_UP,              MO(3),
        MO(2),         KC_LALT,      KC_LGUI,                               KC_SPC,                                                         KC_RGUI,     MO(2),        KC_LEFT,     KC_DOWN,            KC_RGHT
    ),
     ...
     [1] = LAYOUT(
        ...
        KC_LCTL,       KC_A,         KC_S,        KC_D,        KC_F,        KC_G,        KC_H,        KC_J,        KC_K,       KC_L,        KC_SCLN,     KC_QUOT,                   KC_ENT,             KC_PGDN,
        KC_LSFT,       KC_LSFT,      KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_N,        KC_M,       KC_COMM,     KC_DOT,      KC_SLSH,      KC_RSFT,     KC_UP,              MO(3),
        MO(2),         KC_NO,        KC_LALT,                               KC_SPC,                                                         KC_RGUI,     MO(2),        KC_LEFT,     KC_DOWN,            KC_RGHT
    ),
    ...
    [3] = LAYOUT(
        ...
        RGB_TOG,       _______,      _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,    TO(5),        TO(4),        TO(1),      TO(0),              _______,
        KC_CAPS,       RGB_MOD,      RGB_HUI,     RGB_SAI,     RGB_VAI,     RGB_SPI,     _______,     _______,     _______,     _______,    _______,      _______,                  _______,            _______,
        _______,       _______,      RGB_RMOD,    RGB_HUD,     RGB_SAD,     RGB_VAD,     RGB_SPD,     NK_TOGG,     _______,     _______,    _______,      _______,      _______,    _______,            _______,
